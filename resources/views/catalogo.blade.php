        ...
        <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                <div class="navbar-nav ml-auto py-0">
                    ...
                    <li class="nav-item"><a href="catalogo.html"class="nav-link active">Catálogo</a></li>
                    <li class="nav-item"><a href="pqrs.html"    class="nav-link">PQRS</a></li>
                    <li class="nav-item"><a href="ubicacion.html"class="nav-link">Ubicación</a></li>
    ...
    <div class="container-fluid bg-dark text-white py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href="nosotros.html"><i class="fa fa-angle-right mr-2"></i>Sobre Nosotros</a>
                    <a class="text-white mb-2" href="catalogo.html"><i class="fa fa-angle-right mr-2"></i>Nuestro Catalogo</a>
                    <a class="text-white mb-2" href="ubicacion.html"><i class="fa fa-angle-right mr-2"></i>Ubicanos Mejor</a>
        ...
        <div class="container border-top border-secondary pt-5">
            <p class="m-0 text-center text-white">
                &copy; <a class="text-white font-weight-bold" href="#">Maderalpes</a>. All Rights Reserved. Designed by
